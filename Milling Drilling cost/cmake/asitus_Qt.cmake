...
if (NOT BUILD_ALGO_ONLY)
  if (WIN32)
	...
	install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5OpenGL.dll  CONFIGURATIONS Release DESTINATION bin)
	...
	install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5OpenGL.dll   CONFIGURATIONS RelWithDebInfo DESTINATION bini)
	...
	install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5OpenGLd.dll  CONFIGURATIONS Debug DESTINATION bind)
