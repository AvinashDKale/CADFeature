...
// // myView->ChangeRenderingParams().StatsPosition = Graphic3d_RenderingParams::StatsPosition;
//  // Access the StatsPosition transformation
//  Handle(Graphic3d_TransformPers) transform = myView->ChangeRenderingParams().StatsPosition;
//  // Get the current transformation (gp_Trsf)
//// Create a transformation object (gp_Trsf) for the desired translation
//  gp_Trsf translation;
//  // Set the translation to move the object to the bottom
//  // Assuming the bottom is -100 on the Z-axis (adjust as needed)
//  translation.SetTranslation(gp_Vec(0.0, 0.0, -100.0));  // Moving along the Z-axis
//      // Apply this transformation to StatsPosition
...
void OcctQtViewer::initializeGL()
{
  ...
  //      //m_reader->ReadFile(filePath.toStdString().c_str());
